...
void solve(ll tt)
{
    // count map and pie in the string
    // corner case mapie ; count is 2 but removing only 1 character is enough 
    string s; 
    int len; 
    cin>>len; 
    cin>>s; 
    ...
    for (int i=0; i<len-2; i++)
    {
        ...
        if ((i<len-4) and (s.substr(i, 5)=="mapie"))
        {
            cnt++;
            i=i+4; 
        }
            
        else if (s.substr(i, 3)=="pie" or s.substr(i, 3)=="map")
            cnt++; 
    }
